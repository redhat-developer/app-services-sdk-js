...
export const AclsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAcls: async (resourceType?: AclResourceTypeFilter, resourceName?: string, patternType?: AclPatternTypeFilter, principal?: string, operation?: AclOperationFilter, permissionType?: any, page?: number, size?: number, order?: SortDirection, orderKey?: AclBindingOrderKey, permission?: AclPermissionTypeFilter, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/rest/acls`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            if (permissionType !== undefined) {
                localVarQueryParameter['permissionType'] = permissionType;
            }
...
export const AclsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAcls(resourceType?: AclResourceTypeFilter, resourceName?: string, patternType?: AclPatternTypeFilter, principal?: string, operation?: AclOperationFilter, permissionType?: any, page?: number, size?: number, order?: SortDirection, orderKey?: AclBindingOrderKey, permission?: AclPermissionTypeFilter, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AclBindingListPage>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAcls(resourceType, resourceName, patternType, principal, operation, permissionType, page, size, order, orderKey, permission, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AclsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAcls(resourceType?: AclResourceTypeFilter, resourceName?: string, patternType?: AclPatternTypeFilter, principal?: string, operation?: AclOperationFilter, permissionType?: any, page?: number, size?: number, order?: SortDirection, orderKey?: AclBindingOrderKey, permission?: AclPermissionTypeFilter, options?: any): AxiosPromise<AclBindingListPage> {
            return localVarFp.getAcls(resourceType, resourceName, patternType, principal, operation, permissionType, page, size, order, orderKey, permission, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface AclsApiInterface {
     ...
     * @memberof AclsApiInterface
     */
    getAcls(resourceType?: AclResourceTypeFilter, resourceName?: string, patternType?: AclPatternTypeFilter, principal?: string, operation?: AclOperationFilter, permissionType?: any, page?: number, size?: number, order?: SortDirection, orderKey?: AclBindingOrderKey, permission?: AclPermissionTypeFilter, options?: AxiosRequestConfig): AxiosPromise<AclBindingListPage>;
...
export class AclsApi extends BaseAPI implements AclsApiInterface {
     ...
     * @memberof AclsApi
     */
    public getAcls(resourceType?: AclResourceTypeFilter, resourceName?: string, patternType?: AclPatternTypeFilter, principal?: string, operation?: AclOperationFilter, permissionType?: any, page?: number, size?: number, order?: SortDirection, orderKey?: AclBindingOrderKey, permission?: AclPermissionTypeFilter, options?: AxiosRequestConfig) {
        return AclsApiFp(this.configuration).getAcls(resourceType, resourceName, patternType, principal, operation, permissionType, page, size, order, orderKey, permission, options).then((request) => request(this.axios, this.basePath));
    }
}
