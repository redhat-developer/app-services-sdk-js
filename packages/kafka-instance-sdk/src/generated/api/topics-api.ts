...
export const TopicsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTopics: async (filter?: string, limit?: number, offset?: number, order?: SortDirection, orderKey?: TopicOrderKey, page?: number, size?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/rest/topics`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const TopicsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteTopic(topicName: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>> {
         ...
         * @throws {RequiredError}
         */
        async getTopics(filter?: string, limit?: number, offset?: number, order?: SortDirection, orderKey?: TopicOrderKey, page?: number, size?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TopicsList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTopics(filter, limit, offset, order, orderKey, page, size, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a the configuration settings for a topic.
...
export const TopicsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteTopic(topicName: string, options?: any): AxiosPromise<Array<string>> {
         ...
         * @throws {RequiredError}
         */
        getTopics(filter?: string, limit?: number, offset?: number, order?: SortDirection, orderKey?: TopicOrderKey, page?: number, size?: number, options?: any): AxiosPromise<TopicsList> {
            return localVarFp.getTopics(filter, limit, offset, order, orderKey, page, size, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a the configuration settings for a topic.
         * @summary Updates a single topic
...
export interface TopicsApiInterface {
     ...
     * @memberof TopicsApiInterface
     */
    deleteTopic(topicName: string, options?: AxiosRequestConfig): AxiosPromise<Array<string>>;
     ...
     * @memberof TopicsApiInterface
     */
    getTopics(filter?: string, limit?: number, offset?: number, order?: SortDirection, orderKey?: TopicOrderKey, page?: number, size?: number, options?: AxiosRequestConfig): AxiosPromise<TopicsList>;
...
export class TopicsApi extends BaseAPI implements TopicsApiInterface {
     ...
     * @memberof TopicsApi
     */
    public getTopics(filter?: string, limit?: number, offset?: number, order?: SortDirection, orderKey?: TopicOrderKey, page?: number, size?: number, options?: AxiosRequestConfig) {
        return TopicsApiFp(this.configuration).getTopics(filter, limit, offset, order, orderKey, page, size, options).then((request) => request(this.axios, this.basePath));
    }
