...
export const InfoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getSchema: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/serviceregistry_mgmt/v1`;
...
export const InfoApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getSchema(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const InfoApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSchema(options?: any): AxiosPromise<void> {
...
export class InfoApi extends BaseAPI implements InfoApiInterface {
    ...
    public getSchema(options?: any) {
        return InfoApiFp(this.configuration).getSchema(options).then((request) => request(this.axios, this.basePath));
    }
}
