...
export const ServiceAccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getServiceAccounts: async (first?: number, max?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/apis/service_accounts/v1`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ServiceAccountsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getServiceAccounts(first?: number, max?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ServiceAccountData>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getServiceAccounts(first, max, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a service account by id.
...
export const ServiceAccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getServiceAccounts(first?: number, max?: number, options?: any): AxiosPromise<Array<ServiceAccountData>> {
            return localVarFp.getServiceAccounts(first, max, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a service account by id.
         * @summary Update service account
...
export interface ServiceAccountsApiInterface {
     ...
     * @memberof ServiceAccountsApiInterface
     */
    getServiceAccounts(first?: number, max?: number, options?: AxiosRequestConfig): AxiosPromise<Array<ServiceAccountData>>;
...
export class ServiceAccountsApi extends BaseAPI implements ServiceAccountsApiInterface {
     ...
     * @memberof ServiceAccountsApi
     */
    public getServiceAccounts(first?: number, max?: number, options?: AxiosRequestConfig) {
        return ServiceAccountsApiFp(this.configuration).getServiceAccounts(first, max, options).then((request) => request(this.axios, this.basePath));
    }
