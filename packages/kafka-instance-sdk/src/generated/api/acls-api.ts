...
export const AclsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteAcls: async (operation?: AclOperationFilter, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/rest/acls`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getAcls: async (operation?: AclOperationFilter, order?: SortDirection, orderKey?: AclBindingOrderKey, page?: number, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, size?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/rest/acls`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const AclsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteAcls(operation?: AclOperationFilter, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AclBindingListPage>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteAcls(operation, patternType, permission, principal, resourceName, resourceType, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve the resources and associated operations that may have ACLs configured.
         ...
         * @throws {RequiredError}
         */
        async getAcls(operation?: AclOperationFilter, order?: SortDirection, orderKey?: AclBindingOrderKey, page?: number, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, size?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AclBindingListPage>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAcls(operation, order, orderKey, page, patternType, permission, principal, resourceName, resourceType, size, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AclsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteAcls(operation?: AclOperationFilter, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, options?: any): AxiosPromise<AclBindingListPage> {
            return localVarFp.deleteAcls(operation, patternType, permission, principal, resourceName, resourceType, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve the resources and associated operations that may have ACLs configured.
         * @summary Retrieve allowed ACL resources and operations
         ...
         * @throws {RequiredError}
         */
        getAcls(operation?: AclOperationFilter, order?: SortDirection, orderKey?: AclBindingOrderKey, page?: number, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, size?: number, options?: any): AxiosPromise<AclBindingListPage> {
            return localVarFp.getAcls(operation, order, orderKey, page, patternType, permission, principal, resourceName, resourceType, size, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface AclsApiInterface {
     ...
     * @memberof AclsApiInterface
     */
    deleteAcls(operation?: AclOperationFilter, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, options?: AxiosRequestConfig): AxiosPromise<AclBindingListPage>;
     ...
     * @memberof AclsApiInterface
     */
    getAcls(operation?: AclOperationFilter, order?: SortDirection, orderKey?: AclBindingOrderKey, page?: number, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, size?: number, options?: AxiosRequestConfig): AxiosPromise<AclBindingListPage>;
...
export class AclsApi extends BaseAPI implements AclsApiInterface {
     ...
     * @memberof AclsApi
     */
    public deleteAcls(operation?: AclOperationFilter, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, options?: AxiosRequestConfig) {
        return AclsApiFp(this.configuration).deleteAcls(operation, patternType, permission, principal, resourceName, resourceType, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AclsApi
     */
    public getAcls(operation?: AclOperationFilter, order?: SortDirection, orderKey?: AclBindingOrderKey, page?: number, patternType?: AclPatternTypeFilter, permission?: AclPermissionTypeFilter, principal?: string, resourceName?: string, resourceType?: AclResourceTypeFilter, size?: number, options?: AxiosRequestConfig) {
        return AclsApiFp(this.configuration).getAcls(operation, order, orderKey, page, patternType, permission, principal, resourceName, resourceType, size, options).then((request) => request(this.axios, this.basePath));
    }
}
